...
export default function FAQPage() {
  ...
  useEffect(() => {
    ...
    const firstMatch = filteredFaqs[0]?.questions[0];
    ...
    const timeout = setTimeout(() => {
      setOpen(firstMatch.q);

      requestAnimationFrame(() => {
        const faq = faqRefs.current[firstMatch.q];
      ...
      <section className='max-w-6xl mx-auto px-6 pb-24'>
        <div className='relative overflow-hidden rounded-3xl border border-purple-500/20 bg-gradient-to-r from-purple-900/40 to-pink-900/30 p-10'>
          ...
          <div className='relative z-10 flex flex-col md:flex-row items-center justify-between gap-8'>
            ...
            <button
              type='button'
              className='flex items-center gap-2 rounded-xl bg-gradient-to-r from-purple-600 to-pink-500 px-6 py-3 font-medium'
            >
