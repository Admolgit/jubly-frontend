  ...
  return (
    <div className="">
      <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6">
        <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm dark:bg-black">
          <div className="flex items-center justify-between mb-10">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-md font-semibold text-[#111827] dark:text-white">
                Payout Summary
              </h2>
            </div>
        ...
        <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm flex flex-col justify-between dark:bg-black">
          <div>
            ...
            <h3 className="text-md font-semibold text-[#111827] mb-3 dark:text-white">
              Secure & Reliable
            </h3>
